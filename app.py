...
def _event_handler(event_type, slack_event):
    ...
    if event_type == "team_join":
        ...
        print slack_event;
        print "--------------------";
        channel_id = "C8K9YNWP4";
        msg = "Enter your time zone in HH:MM format"
        pyBot.auth("xoxb-292179794549-I70O4P0lniir1pNhZLllJXbu");
        pyBot.send_msg(channel_id, msg)
    ...
    # shared by looking into the attachments for "is_shared".
        ...
        t_zone = slack_event["event"]["text"]
        msg = "Your time zone is : "+ t_zone;

        if "username" not in slack_event["event"] and "joined" not in t_zone :
        	pyBot.auth("xoxb-292179794549-I70O4P0lniir1pNhZLllJXbu");
        	pyBot.send_msg(channel_id, msg)
        	print "Sent !!"
